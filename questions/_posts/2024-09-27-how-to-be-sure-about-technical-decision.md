...
Если видно, что решение описывает только техническую реализацию и не понятно откуда и почему решение взялось, то решение придется отклонить или попросить доделать (либо помочь с переделкой).
...
**Важно**: учтите, что «важное или полезное» для бизнеса =/= «важное или полезное» для инженеров. Связано это с тем, что «бизнес» видит больше не технические проблемы и там другие приоритеты. Лично видел (и сам сталкивался), как подобная ситуация загоняет разработчиков в депрессию, потому что кажется, что потратить месяц на ускорение страницы на 100мс необходимо, а у бизнеса кончились деньги, нет продаж и еще конкуренты давят. Вот тут как раз еще один пример когда изучение надсистем позволит справиться с подобными ситуациями.
